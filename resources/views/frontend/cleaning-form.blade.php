        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card ">
                    ...
                    <form action="{{route('cleaning.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div>
                                            <label for="labelInput" class="form-label">Talep Yapan Birim  <span
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div>
                                            ...
                                            <span class="text-danger">@error('cep_telefonu')
                                                {{ $message }}
                                                @enderror
                            </span>
                                        </div>
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div>
                                            ...
                                            <span class="text-danger">@error('talep_saati')
                                                {{ $message }}
                                                @enderror
                            </span>
                                        </div>
