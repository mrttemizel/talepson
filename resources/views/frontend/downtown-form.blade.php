...
@push('title', 'DOWNTOWN TEKNİK SERVİS TALEP FORMU')
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">DOWNTOWN TEKNİK SERVİS TALEP FORMU</h4>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item bg-danger bg-opacity-10">- Talepleriniz sıraya konularak yapılacaktır..</li>
                    ...
                    <form action="{{route('frontend.request-downtown.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div>
                                            ...
                                            <select class="form-select" name="talep_tipi"  aria-label="Default select example">
                                                ...
                                                <option value="1" {{ old('talep_tipi') == 1 ? 'selected' : '' }}>Bilgisayar</option>
                                                <option value="2" {{ old('talep_tipi') == 2 ? 'selected' : '' }}>Ses Sistemi</option>
                                                <option value="3" {{ old('talep_tipi') == 3 ? 'selected' : '' }}>Klima</option>
                                                <option value="4" {{ old('talep_tipi') == 4 ? 'selected' : '' }}>Teknik Servis</option>
